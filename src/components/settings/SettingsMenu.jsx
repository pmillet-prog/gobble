...
import AnimatedTimeWheel, {
  ...
  buildTimeWheelRollSegments as buildPlaytimeRollSegments,
  clampTimeWheelValue as clampOptionValue,
  getTimeWheelIndex as getOptionIndex,
  shiftTimeWheelValue as shiftOptionValue,
      ...
      <SettingsPanelHost
        ...
        visual={{
          ...
          props: {
            ...
            onTogglePresenterAnimations: () =>
              setVisualPresenterAnimationsEnabled((prev) => !prev),
