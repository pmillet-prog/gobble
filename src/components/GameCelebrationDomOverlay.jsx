...
function GameCelebrationDomOverlay({
  assetsReady = false,
  hostRef = null,
  ...
  const { invalidFlash } = snapshot;
  const gobbleFlash = onlyInvalid ? null : snapshot.gobbleFlash;
  const praiseFlash = onlyInvalid ? null : snapshot.praiseFlash;
...
export default React.memo(GameCelebrationDomOverlay);
