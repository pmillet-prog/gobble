...
export const BOT_ROSTER_4X4 = [
  ...
  { nick: "PapiRatatouille", skill: 0.78, maxWordsPerRound: 75, minWordsPerRound: 32, pointBias: 0.82, pace: 0.98, sleep: { startHour: 3, durationHours: 9 } },
  { nick: "MademoiselleP", skill: 0.72, maxWordsPerRound: 73, minWordsPerRound: 30, pointBias: 0.78, pace: 1.02, sleep: { startHour: 2, durationHours: 8 } },
  { nick: "BiscotteTurbo", skill: 0.68, maxWordsPerRound: 71, minWordsPerRound: 28, pointBias: 0.74, pace: 1.08, sleep: { startHour: 1, durationHours: 8 } },
  { nick: "LeChienSavant", skill: 0.64, maxWordsPerRound: 68, minWordsPerRound: 26, pointBias: 0.7, pace: 0.96, sleep: { startHour: 4, durationHours: 9 } },
  { nick: "GastonLaGaffe", skill: 0.6, maxWordsPerRound: 66, minWordsPerRound: 24, pointBias: 0.68, pace: 0.9, sleep: { startHour: 0, durationHours: 8 } },
  { nick: "MlleDiagonale", skill: 0.58, maxWordsPerRound: 64, minWordsPerRound: 24, pointBias: 0.62, pace: 1.05 },
  { nick: "TropDeCafé", skill: 0.56, maxWordsPerRound: 62, minWordsPerRound: 22, pointBias: 0.6, pace: 1.12, sleep: { startHour: 5, durationHours: 8 } },
  { nick: "PixelBaguette", skill: 0.54, maxWordsPerRound: 60, minWordsPerRound: 22, pointBias: 0.58, pace: 1.0 },
  { nick: "ClaviersFou", skill: 0.52, maxWordsPerRound: 59, minWordsPerRound: 20, pointBias: 0.56, pace: 1.1, sleep: { startHour: 2, durationHours: 8 } },
  { nick: "LaMoucheDuCoche", skill: 0.5, maxWordsPerRound: 58, minWordsPerRound: 20, pointBias: 0.54, pace: 0.88 },
  { nick: "TuilesEnFolies", skill: 0.48, maxWordsPerRound: 56, minWordsPerRound: 18, pointBias: 0.52, pace: 0.95, sleep: { startHour: 1, durationHours: 9 } },
  { nick: "BarbeAPapa", skill: 0.46, maxWordsPerRound: 54, minWordsPerRound: 18, pointBias: 0.5, pace: 1.02 },
  { nick: "ZesteDeLime", skill: 0.44, maxWordsPerRound: 52, minWordsPerRound: 17, pointBias: 0.48, pace: 0.92 },
  { nick: "MarcelDu12", skill: 0.42, maxWordsPerRound: 49, minWordsPerRound: 16, pointBias: 0.46, pace: 1.08, sleep: { startHour: 4, durationHours: 8 } },
  { nick: "CarotteRâpée", skill: 0.4, maxWordsPerRound: 47, minWordsPerRound: 15, pointBias: 0.44, pace: 0.9 },
  { nick: "KouignAmann", skill: 0.38, maxWordsPerRound: 41, minWordsPerRound: 14, pointBias: 0.42, pace: 0.98, sleep: { startHour: 2, durationHours: 9 } },
  { nick: "MadameMots", skill: 0.36, maxWordsPerRound: 44, minWordsPerRound: 14, pointBias: 0.4, pace: 1.04 },
  { nick: "CapitaineAccent", skill: 0.34, maxWordsPerRound: 42, minWordsPerRound: 13, pointBias: 0.38, pace: 0.86 },
  { nick: "DodoDansLeMétro", skill: 0.32, maxWordsPerRound: 38, minWordsPerRound: 12, pointBias: 0.36, pace: 0.82, sleep: { startHour: 2, durationHours: 10 } },
  { nick: "PommeTatin", skill: 0.3, maxWordsPerRound: 35, minWordsPerRound: 12, pointBias: 0.34, pace: 0.94 },
  { nick: "ChocolatineDebat", skill: 0.28, maxWordsPerRound: 21, minWordsPerRound: 11, pointBias: 0.32, pace: 1.06 },
  { nick: "SaucissonSec", skill: 0.26, maxWordsPerRound: 26, minWordsPerRound: 10, pointBias: 0.3, pace: 0.86, sleep: { startHour: 3, durationHours: 8 } },
  { nick: "PetitPoucet", skill: 0.24, maxWordsPerRound: 24, minWordsPerRound: 10, pointBias: 0.28, pace: 0.9 },
  { nick: "TourEiffel", skill: 0.22, maxWordsPerRound: 28, minWordsPerRound: 9, pointBias: 0.26, pace: 0.78 },
  ...
  { nick: "MotsMarmiton", skill: 0.19, maxWordsPerRound: 24, minWordsPerRound: 8, pointBias: 0.22, pace: 0.82 },
  { nick: "ZigzagZen", skill: 0.18, maxWordsPerRound: 22, minWordsPerRound: 8, pointBias: 0.22, pace: 0.9 },
  { nick: "Nougatine", skill: 0.17, maxWordsPerRound: 27, minWordsPerRound: 8, pointBias: 0.2, pace: 0.76, sleep: { startHour: 4, durationHours: 9 } },
  { nick: "CiseauPapierMot", skill: 0.16, maxWordsPerRound: 25, minWordsPerRound: 8, pointBias: 0.18, pace: 0.72 },
  { nick: "Torto", skill: 0.12, maxWordsPerRound: 18, minWordsPerRound: 5, pointBias: 0.18, pace: 0.7 },
  { nick: "LazyLlama", skill: 0.05, maxWordsPerRound: 16, minWordsPerRound: 4, pointBias: 0.16, pace: 0.68 },
